                ...
                for mgid in sorted(Hosts[host]['plugins'][plugin]['mgids'].keys()):
                    if Hosts[host]['plugins'][plugin]['mgids'][mgid]['checked']:
                        ...
                        if Options['if']['value'] == 'CSV':
                            ...
                            if ('no-long-names' in MCconfig['Options'] or Options['ta']['disabled'] == 'disabled'):
                            ...
                            for ds in data_sources:
                                Columns += [ds]
                                ds_path = data_path + '-' + ds + MCutils.MuninType(PluginConfigs['config'][PluginConfigs['links'][host][plugin]][mgid], ds) + '.rrd'
